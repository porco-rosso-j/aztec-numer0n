...
export class Numer0nContract extends ContractBase {
	...
	public methods!: {
		...
		_add_num: ((_player: FieldLike) => ContractFunctionInteraction) &
			Pick<ContractMethod, "selector">;

		/** _add_player(_player: field, _player_id: field) */
		_add_player: ((
			_player: FieldLike,
			_player_id: FieldLike
		) => ContractFunctionInteraction) &
			Pick<ContractMethod, "selector">;

		/** _assert_is_player(_player: field) */
		_assert_is_player: ((_player: FieldLike) => ContractFunctionInteraction) &
			Pick<ContractMethod, "selector">;

		/** _record_item_result(_caller: field, _item_type: field, _item_result: field) */
		_record_item_result: ((
			_caller: FieldLike,
			_item_type: FieldLike,
			_item_result: FieldLike
		) => ContractFunctionInteraction) &
			Pick<ContractMethod, "selector">;
