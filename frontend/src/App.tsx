...
function Game() {
	...
	const [playerWallet, setPlayerWallet] =
		useState<AccountWalletWithPrivateKey>();
	const [gameID, setGameID] = useState<string>("");
	const registryAddr = AztecAddress.fromString(
		"0x239a5f10f6b315de7d53fafe718ca522c8172443634b36fc089f639c72b3a690"
	);
	...
	(async () => {
		...
		if (!pxe) return;
		const [player]: AccountWalletWithPrivateKey[] =
