...
import RegistryContractArtifactJson from '../../target/registry_contract-Registry.json' assert { type: 'json' };
export const RegistryContractArtifact = loadContractArtifact(RegistryContractArtifactJson as NoirCompiledContract);
...
export class RegistryContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<RegistryContract>(Point.ZERO, wallet, RegistryContractArtifact, RegistryContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, ) {
    return new DeployMethod<RegistryContract>(publicKey, wallet, RegistryContractArtifact, RegistryContract.at, Array.from(arguments).slice(2));
  }
